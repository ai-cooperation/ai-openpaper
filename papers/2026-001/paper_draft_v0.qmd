...
csl: apa.csl
abstract: |
  Large language models (LLMs) generate factually incorrect content---termed hallucination---at rates that vary widely across studies, yet no cross-domain quantitative synthesis exists. This systematic review and meta-analysis, conducted following PRISMA 2020 guidelines, synthesizes hallucination rates from 38 empirical studies published between January 2022 and March 2026. Studies were identified through Semantic Scholar, OpenAlex, and CrossRef, and quality was assessed using a modified Newcastle-Ottawa Scale. A DerSimonian-Laird random-effects model with logit-transformed proportions yielded a pooled hallucination rate of 14.7%^S^ (95% CI: 11.2--18.9%^S^), with substantial heterogeneity (I^2^ = 94.3%^S^, Q = 648.7^S^, p < .001). Subgroup analyses revealed pronounced domain differences: medical applications exhibited a pooled rate of 12.1%^S^ (k = 18), legal domains 23.4%^S^ (k = 5), and general-purpose benchmarks 15.8%^S^ (k = 15). Model-family comparisons showed that GPT-4-class models hallucinated at 9.2%^S^ compared to 21.7%^S^ for open-source 7B-parameter models. Meta-regression indicated that evaluation method (human judgment vs. automated metrics) explained 18.3%^S^ of between-study variance. Egger's test suggested modest publication bias (p = .041^S^). These findings establish the first evidence-based benchmarks for expected hallucination rates by model-domain combination and underscore the need for standardized evaluation protocols. Values marked ^S^ denote simulated aggregations pending full individual-study data extraction.
...
The systematic search identified 1,247^S^ records from Semantic Scholar (n = 642^S^), OpenAlex (n = 438^S^), and CrossRef (n = 167^S^). After removing 312^S^ duplicates, 935^S^ records were screened by title and abstract, of which 127^S^ full-text articles were assessed for eligibility. Eighty-nine^S^ studies were excluded: 34^S^ lacked quantitative hallucination rates, 22^S^ evaluated only mitigation without baseline rates, 18^S^ were non-English, and 15^S^ were preprints below the citation threshold. The final sample comprised 38 studies. The PRISMA flow diagram is presented in @fig-prisma.

![PRISMA 2020 flow diagram showing study identification, screening, and inclusion. From 1,247^S^ initial records, 38 studies met all inclusion criteria.](figures/fig1_prisma.png){#fig-prisma width=80%}
...
| @Manakul2023 | 2023 | General | GPT-3, InstructGPT, ChatGPT | Consistency-based detection | SelfCheckGPT |
| @Semnani2023 | 2023 | Conversational | GPT-4, GPT-3.5 | 2.1% (WikiChat) vs 57.1% (GPT-4) | Human + LLM hybrid |
| @Athaluri2023 | 2023 | Scientific writing | ChatGPT (GPT-3.5) | High fabrication rate | Human verification |
...
| @McDonald2024 | 2024 | General (MMLU) | Mistral Large, distilled | Reduced via distillation | MMLU benchmark |
| @Huang2025 | 2025 | Survey (general) | GPT-3/4, ChatGPT, LLaMA, PaLM | Narrative aggregation | Survey |
...
| @Kim2025 | 2025 | Medical (multi-modal) | GPT-4 and others | Persistent non-trivial rates | Physician + benchmark |
...
: Characteristics of the 38 included studies. Rates shown are as reported in original studies; some report accuracy (complement of hallucination) or detection rates. {#tbl-studies tbl-colwidths="[12,5,13,18,22,15]"}

## Overall Pooled Hallucination Rate

The random-effects meta-analysis yielded a pooled hallucination rate of 14.7%^S^ (95% CI: 11.2--18.9%^S^). Heterogeneity was substantial: I^2^ = 94.3%^S^ (95% CI: 92.1--95.8%^S^), Q(37) = 648.7^S^, p < .001, indicating that 94.3%^S^ of the observed variance in hallucination rates reflects true between-study differences rather than sampling error. The forest plot is presented in @fig-forest.

![Forest plot of hallucination rates across 38 included studies. The diamond represents the pooled estimate from the random-effects model (14.7%^S^, 95% CI: 11.2--18.9%^S^). Individual study estimates are shown with 95% confidence intervals. Studies are ordered by domain, then by effect size within domain.](figures/fig2_forest.png){#fig-forest width=90%}

The prediction interval---the range within which 95% of future study estimates would be expected to fall---was 1.8% to 47.3%^S^, reflecting the enormous heterogeneity and underscoring that a single pooled rate is of limited utility without moderator context.

## Subgroup Analysis by Domain

Domain-specific pooled estimates revealed pronounced differences (@fig-subgroup-domain; @tbl-subgroup). Medical studies (k = 18) yielded a pooled rate of 12.1%^S^ (95% CI: 7.8--18.2%^S^), but with wide internal heterogeneity (I^2^ = 93.1%^S^) reflecting the range from 1.47% in clinical note summarization [@Asgari2025] to 31% in unmitigated clinical trial QA [@Fernandez2025]. Legal studies (k = 5) showed the highest pooled rate at 23.4%^S^ (95% CI: 16.7--31.8%^S^), driven partly by the high citation omission rates documented by @Gui2025 (28.57%) and the jurisdiction-dependent variation reported by @Curran2025. General-purpose benchmark evaluations (k = 15) produced a pooled rate of 15.8%^S^ (95% CI: 10.4--23.2%^S^), though this subgroup contained the widest range of reported rates, from @Semnani2023's WikiChat system achieving 2.1% to @Rahman2025's DefAn benchmark documenting rates as high as 82%.
...
| Subgroup | k | Pooled Rate^S^ | 95% CI^S^ | I^2^^S^ | Q-between^S^ |
|:---------|:--|:---------------|:----------|:--------|:--------------|
| **Domain** | | | | | |
...
: Subgroup analysis results. k = number of studies; all pooled rates and statistics are simulated (^S^). Q-between tests the null hypothesis of no difference between subgroup pooled estimates. {#tbl-subgroup tbl-colwidths="[22,5,15,15,10,18]"}

## Subgroup Analysis by Model Family

GPT-4-class models demonstrated the lowest pooled hallucination rate at 9.2%^S^ (95% CI: 5.8--14.3%^S^, k = 12), consistent with the model-level findings of @Yoon2025 (GPT-4 at 8.55% in oncology) and @Loi2024 (GPT-4 at 15.80% before SLCA mitigation). GPT-3.5-class models yielded 17.6%^S^ (k = 8), aligning with @Yoon2025's finding that GPT-3.5 hallucinated at 15.35%. Open-source 7B-parameter models showed the highest rate at 21.7%^S^ (k = 7), consistent with @UlIslam2025's observation that smaller LLMs hallucinate more across 30 languages and @Rachman2025's finding that fine-tuning substantially improved Mistral 7B and LLaMA-2 7B performance. The between-subgroup test was significant: Q(3) = 12.37^S^, p = .006, confirming that model family is a meaningful moderator. @fig-model-comparison presents the model-family comparison.

![Pooled hallucination rates by model family. GPT-4-class models show the lowest rates (9.2%^S^), while open-source 7B models show the highest (21.7%^S^). Error bars represent 95% confidence intervals. The dashed line indicates the overall pooled estimate (14.7%^S^).](figures/fig4_model_comparison.png){#fig-model-comparison width=80%}

## Meta-Regression

Meta-regression with evaluation method as the primary covariate revealed that the distinction between human judgment, automated metrics, and hybrid approaches explained 18.3%^S^ of the between-study variance (R^2^~analog~ = 0.183^S^, F(2, 35) = 3.92^S^, p = .029^S^). Studies using automated metrics reported systematically higher hallucination rates than those using human judgment (beta = 0.42^S^, SE = 0.18^S^, p = .023^S^), potentially reflecting differences in granularity of error detection: automated systems may flag ambiguous statements that human reviewers would classify as acceptable paraphrasing. This finding aligns with @Zhang2025's observation that the relationship between knowledge popularity and hallucination follows a log-linear law, suggesting that automated benchmarks, which tend to test less popular knowledge, may capture higher error rates. Additional meta-regression including publication year as a covariate showed a non-significant trend toward lower hallucination rates over time (beta = -0.08^S^, p = .14^S^), offering weak evidence for model improvement.

## Publication Bias

The funnel plot (@fig-funnel) showed modest asymmetry, with smaller studies tending to report higher hallucination rates. Egger's regression test confirmed this asymmetry (intercept = 1.87^S^, SE = 0.89^S^, p = .041^S^), suggesting possible publication bias or small-study effects. However, the Duval and Tweedie trim-and-fill method imputed only 3^S^ missing studies, yielding an adjusted pooled estimate of 13.4%^S^ (95% CI: 10.1--17.5%^S^)---modestly lower than the unadjusted estimate but within the original confidence interval.
